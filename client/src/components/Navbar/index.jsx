        ...
        <Box bg='#24292f' w='100%' style={{ padding: "16px 32px", lineHeight: 1.5 }} color='white' display="flex" justifyContent="space-between" alignItems={"center"}>
            ...
            <Box>
                <Flex justifyContent="center" alignItems="center">
                    <a href='!#'>
                        <svg height="32" style={{ fill: "white" }} aria-hidden="true" viewBox="0 0 16 16" version="1.1" width="32" data-view-component="true" class="octicon octicon-mark-github v-align-middle">
