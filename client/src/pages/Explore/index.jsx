    ...
    return (
        <Box width="100%">
            ...
            <Box id="explore-content">
                <Container width="100vw" maxW='container.lg'>
                    <Grid templateColumns='repeat(12, 1fr)' gap={6}>
                        <GridItem colSpan={3}>
                            <Box className='explore-content-card' border="1px" borderColor="blackAlpha.300" borderRadius="md">
                                ...
                                <Divider />
                                <Text as="h3" marginLeft="16px" marginTop="16px" marginBottom="16px">0 starred topics</Text>
                                <Divider />
                                <Text as="h3" marginLeft="16px" marginTop="16px" marginBottom="16px">10 starred repositories</Text>
                            </Box>
                        </GridItem>
                        <GridItem bg='blue.500' colSpan={6}>
