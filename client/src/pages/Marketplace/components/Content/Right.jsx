                    ...
                    <GridItem colSpan="1">
                        {
                            apps.map(item => (
                                ...
                                >
                                    <GridItem colSpan="1">
                                        <Image borderRadius="50%" width="60px" height="60px" src='https://images.unsplash.com/photo-1659631222920-4e085f98a4e0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1632&q=80' alt='resim 1' />
                                    </GridItem>
                                    <GridItem colSpan="6">
                                        ...
                                        <Text as="h5" display="flex" alignItems="center" fontSize="14px" color="blackAlpha.800">{item.author}
                                            <span style={{ marginLeft: "5px" }}>
                                                <svg aria-hidden="true" fill='#0969DA' height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-verified color-fg-accent ml-1">
                                        ...
                                        <Text as="span" fontSize="12px" border="1px" padding="2px" fontWeight="bold" color="gray" borderColor="gray" borderRadius="14px">{item.install}</Text>
                                    </GridItem>
                                </Grid>
                            ))
                        }
